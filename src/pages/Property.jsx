...
const Property = () => {
    ...
    //
    //         // Fix: Send an object instead of just the ID
    ...
    //
    //     axios
    //         .post(`http://localhost:8080/api/tenants/${tenantId}/add-${requestType}-request`, requestData, {
    //             headers: { Authorization: `Bearer ${token}` },
    //         })
    //         .then((response) => {
    //             console.log(`${requestType} request added successfully:`, response.data);
    //             setTenant(response.data); // Update the tenant state with the new data
    //         })
    //         .catch((error) => {
    //             console.error("Error adding rental request:", error.response?.data || error.message);
    //         });
